 ...
 * Door het op deze manier te doen omzeil ik een check en kan Yaegermeister (de engine) gewoon starten.
 * Hier begint de hele game eigenlijk, maar die gaat direct door naar AsteroidsGame.main.
 * De String[] args zijn eigenlijk argumenten die je mee kan sturen als je een programma start, maar gebruiken wij niet.
 * 
 * Officiële Documentatie Han Yaeger API:
